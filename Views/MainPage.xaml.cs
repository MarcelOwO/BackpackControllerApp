...
public partial class MainPage 
{
    ...
    public MainPage(ILoggingService loggingService, ISettingsService settingsService, IBluetoothService bluetoothService, IImageService imageService, IStorageService storageService)
    {
